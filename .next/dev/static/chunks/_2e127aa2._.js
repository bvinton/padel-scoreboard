...
function HomePage() {
    ...
    const [lastProcessedId, setLastProcessedId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const winSoundRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    // --- SCREEN WAKE LOCK ---
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HomePage.useEffect": ()=>{
            let wakeLock = null;
            const requestWakeLock = {
                "HomePage.useEffect.requestWakeLock": async ()=>{
                    try {
                        if ('wakeLock' in navigator) wakeLock = await navigator.wakeLock.request('screen');
                    } catch (e) {}
                }
            }["HomePage.useEffect.requestWakeLock"];
            requestWakeLock();
            return ({
                "HomePage.useEffect": ()=>{
        ...
        "HomePage.useEffect": ()=>{
            if (matchWinner && !matchWinnerDismissed && winSoundRef.current) {
                winSoundRef.current.play().catch({
                    "HomePage.useEffect": (e)=>console.log("Audio play blocked by browser")
                }["HomePage.useEffect"]);
            }
        }
    }["HomePage.useEffect"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HomePage.useEffect": ()=>{
            const pollFlic = {
                "HomePage.useEffect.pollFlic": async ()=>{
                    try {
...
_s(HomePage, "lXavkQ7nSWq/TJgzICbLh/A2P6A=", false, function() {
    return [
...
//# sourceMappingURL=_2e127aa2._.js.map